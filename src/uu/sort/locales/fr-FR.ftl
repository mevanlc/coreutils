...
sort-diag-label-missing-count = un nombre est attendu ici
sort-diag-label-zero-count = la numérotation commence à 1
sort-diag-help-key-syntax = une clé s'écrit CHAMP[.CAR][OPTS][,CHAMP[.CAR][OPTS]], comme -k2.3,4nr
