...
sort-diag-label-missing-count = expected a number here
sort-diag-label-zero-count = counting starts at 1
sort-diag-help-key-syntax = a key is FIELD[.CHAR][OPTS][,FIELD[.CHAR][OPTS]], as in -k2.3,4nr
